            ...
            <ListItem
              description={
                <VStack gap={1}>
                  ...
                  <Text
                    className="activity-history-mobile-meta"
                    type="supporting"
                    color="secondary"
                  >
                    {copy.kind[activity.kind]} ·{" "}
                    <time dateTime={activity.occurredAt}>{activity.timeLabel}</time>
                  </Text>
                </VStack>
              }
              endContent={
                <HStack className="activity-history-meta" gap={3} vAlign="center">
              ...
              startContent={
                <span className={`activity-kind-icon history kind-${activity.kind}`}>

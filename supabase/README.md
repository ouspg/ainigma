...
Data changes (`insert`, `update`, `delete`) are not generated by declarative schema diffs. Create a
separate reviewed migration for required data transformations or one-time reconciliation.

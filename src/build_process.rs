...
fn find_flagtype_for_task(course_config: CourseConfiguration, task_id: String) -> Result<Vec<FlagConfig>, String> {
...
fn match_flag_types_and_generate_embed_flags(
    ...
    for flag_type in flag_types {
        ...
        "pure_random" => {
            ...
            let generated_flag =
                flag_generator::Flag::random_flag(flag_type.id.clone(), course_config.flag_types.pure_random.length);
            let embed_flag = EmbedFlag {
                id: flag_type.id.clone(),
                flag: generated_flag,
            };
        ...
        "rng_seed" => {
            ...
            let generated_flag = flag_generator::Flag::user_seed_flag(flag_type.id.clone(), uuid);
            let embed_flag = EmbedFlag {
                id: flag_type.id.clone(),
                flag: generated_flag,
            };
...
fn get_build_info(
    ...
    Err(format!("Build information for task with id {} not found!", task_id))
}
